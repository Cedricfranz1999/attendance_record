  ...
  // }
  {
        ...
        try {
          if (
            ...
            if (singleResult) {
              ...
              if (bestMatch.distance < THRESHOLD) {
                ...
                if (id && activeSubject && activeDate) {
                  ...
                  try {
                    ...
                    //   await refetch();
                    //   console.log("Attendance data refetched after time in");
                    // } else {
                    //   console.error(
                    //     "refetchAttendance is not a function",
                    //     refetchAttendance,
                    //   );
                    // }
                  } catch (error) {
              ...
              setStatusTimeIn(
                "No Face Detected, Come closer or add some light",
              );
              ...
              if (bestMatch.distance < THRESHOLD) {
                ...
                if (id && activeSubject && activeDate) {
                  ...
                  try {
                    ...
                    //   await refetchSubject();
                    //   await refetch();
                    //   console.log("Attendance data refetched after time out");
                    // } else {
                    //   console.error(
                    //     "refetchAttendance is not a function",
                    //     refetchAttendance,
    ...
    useEffect(() => {
      if (faceMatcher && modelsLoaded) {
        ...
        if (
          videoRefTimeOut.current &&
          videoRefTimeOut.current.readyState >= 2
        ) {
        ...
        try {
          ...
          try {
            ...
            if (activeDateRes.ok) {
              ...
              console.error(
                "Failed to fetch active date:",
                activeDateRes.status,
              );
              setError(
