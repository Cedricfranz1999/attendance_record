...
export const DashboardRouter = createTRPCRouter({
  ...
  getAttendanceStatusDistribution: publicProcedure.query(async ({ ctx }) => {
  ...
  getSubjectAttendance: publicProcedure.query(async ({ ctx }) => {
  ...
  getDayOfWeekAttendance: publicProcedure.query(async ({ ctx }) => {
  ...
  getMonthlyComparison: publicProcedure.query(async ({ ctx }) => {
    const attendances = await ctx.db.attendance.findMany();
  ...
  getTimeOfDayPatterns: publicProcedure.query(async ({ ctx }) => {
  ...
  getTeacherPerformance: publicProcedure.query(async ({ ctx }) => {
  ...
  getAttendanceDuration: publicProcedure.query(async ({ ctx }) => {
